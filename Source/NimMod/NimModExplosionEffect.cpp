...
ANimModExplosionEffect::ANimModExplosionEffect(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void ANimModExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void ANimModExplosionEffect::Tick(float DeltaSeconds)
{
