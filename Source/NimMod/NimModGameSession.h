...
#include "NimModGameSession.generated.h"

//struct FNimModSessionParams
//{
 ...
 */
UCLASS(config = Game)
class NIMMOD_API ANimModGameSession : public AGameSession
{
	GENERATED_BODY()

public:
	void RegisterNimModServer(FString IP, FString serverName, FString mapName, int32 maxNumberOfPlayers);
...
//	FNimModSessionParams CurrentSessionParams;
...
//	*/
//	DECLARE_EVENT_TwoParams(ANimModSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
...
//	DECLARE_EVENT_OneParam(ANimModSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
//	FOnJoinSessionComplete JoinSessionCompleteEvent;
//
//	/*
//	* Event triggered after session search completes
//	*/
//	//DECLARE_EVENT(ANimModSession, FOnFindSessionsComplete);
//	DECLARE_EVENT_OneParam(ANimModSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
